...
*/
		...
		$profile = new Profile($profileId, $_SESSION["profile"]->getProfileId, $profileActivationToken, $requestObject->profileBio, $requestObject->profileEmail, $hash, $requestObject->profileImage, $requestObject->profileLocation, $requestObject->profileUsername,);
